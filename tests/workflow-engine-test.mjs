 ...
 *
 * 用法: node tests/workflow-engine-test.mjs
 *
...
// 从文件位置推仓库根：动态 import 用 file:// 地址，换成绝对路径也得走这一步才稳。
...
{
  const { createStudioRegistry } = await import(pathToFileURL(join(repo, 'apps', 'server', 'src', 'workflow', 'nodes.ts')).href)
